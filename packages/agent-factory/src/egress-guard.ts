...
// point fetch at the cluster's own internals — `http://localhost:5433` (Postgres),
// `http://169.254.169.254/...` (cloud metadata), or any private-range service.
// This module closes it, fail-closed: private/loopback/metadata/link-local hosts and
