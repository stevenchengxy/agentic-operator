...
export const ManifestImportBody = z
  .object({
    ...
    // There is currently one real live deployment lane. Do not accept a
    // misleading staging target until the runtime implements staging reads,
    // registration, and promotion semantics end-to-end.
