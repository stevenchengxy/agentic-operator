 ...
 *           api_key_env: "TENANT_X_GOHIRE_KEY", base_url: "...", timeout_ms: 60000
 *      }}]`
 *      `api_key`     — literal key (rare; local override)
 *      `api_key_env` — name of the env var holding the key
 *      `base_url`    — overrides everything below
 ...
 *   3. Global env: GOHIRE_API_KEY, GOHIRE_BASE_URL, GOHIRE_TIMEOUT_MS
 *
